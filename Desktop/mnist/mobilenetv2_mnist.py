...
checkpoint = ModelCheckpoint(
    '../backup/baseline/mobilenetv2_mnist.h5',
...
# 모델 크기 확인
model = keras.models.load_model('../backup/baseline/mobilenetv2_mnist.h5')
model_size = os.path.getsize('../backup/baseline/mobilenetv2_mnist.h5')
